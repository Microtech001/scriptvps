#!/bin/bash
# My Telegram : https://t.me/Microtechvpnservice
# ==========================================
# Color
RED='\033[0;31m'
NC='\033[0m'
...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/Microtech001/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Facebook : https://m.facebook.com/nil"
echo -e "${NC}${LIGHT}WhatsApp : nil"
echo -e "${NC}${LIGHT}Telegram : https://t.me/microtechvpnservice"
exit 0
fi
clear
